	...
	<div class="neo-center">
		<div style="width:auto;" class="neo-xbackground neo-xtransforme-2  ">
			<div class="neo-xbackground neo-xtransforme-1 " style="padding:1px;">
				<p class="neo-text-header-small  neo-xtransforme-2" style="margin-top:10px;text-transform: uppercase;"><b>Confirmation de votre action de modération</b></p>
			</div>
		</div>
	</div>
...
<div class="neo-center">
<div class="neo-xbackground neo-radius" style="padding:15px;">
<?php 
if(isset($_GET['choix']))
{
		...
		if(is_numeric($id) AND is_numeric($choix))
		{
			switch($choix)
			{
				...
				case '2':
					...
					<form method="post" action="?&action=forum_moderation&id_topic=<?php echo $id; ?>&choix=2&confirmation=true" role="form">
						...
						<div class="form-group row">
							<div class="col-sm-10">
								<button type="submit" class="neo-button neo-gray">Supprimer ce topic :(</button>
							</div>
							<div class="col-sm-2">
					<a href="index.php" class="neo-button neo-red">Annuler</a>
				</div>
						</div>
					</form><?php
					}
				...
				case '3':
					...
					<form action="<?php echo $_Serveur_['General']['url']; ?>?&action=forum_moderation&id_topic=<?php echo $id; ?>&choix=3&confirmation=true" method="post">
						...
						<div class="form-group row">
							<div class="col-sm-10">
								<button type="submit" class="neo-button neo-gray">Déplacer la discussion </button>
							</div>
							<div class="col-sm-2">
					<a href="index.php" class="neo-button neo-red">Annuler</a>
				</div>
	...
	if($choix == 4)
		{
			...
			<form action="?&action=signalement&confirmation=true" method="post">
				...
				<div class="row">
					<div class="col-sm-10">
						<button class="neo-button neo-red" type="submit">Signaler ! </button>
					</div>
					<div class="col-sm-2">
					<a href="index.php" class="neo-button neo-red">Annuler</a>
				</div>
	...
	if($choix == 5)
	{
		...
		<form action="?&action=signalement_topic&confirmation=true" method="post">
			...
			<div class="form-group row">
				<div class="col-sm-10">
					<button type="submit" class="neo-button neo-gray">Signaler ce topic !</button>
				</div>
				<div class="col-sm-2">
					<a href="index.php" class="neo-button neo-red">Annuler</a>
				</div>
