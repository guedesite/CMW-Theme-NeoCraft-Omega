...
<html>
	...
	<body class="neo-background-image">
		<div style="position:absolute;width:100%;height:100%;z-index:-9;"><div id="particle-canvas" ></div></div>
		<div  style="z-index:999;position:absolute;width:100%;height:100%;">
		<div class="neo-margin-top-7 neo-margin-bottom-15 neo-margin-left-25 neo-margin-right-25" >
			<div class="neo-center-small neo-padding-16">
				<h2 class="neo-center-simple neo-text"><i class="fa fa-cog fa-spin"></i> Maintenance <i class="fa fa-cog fa-spin"></i></h2>
				<h4 class="neo-center-simple neo-text"><?php echo $donnees['maintenanceMsg']; ?></h4>
			</div>
			...
			<div id="clockdiv">
				<div class="flex-w flex-c-m ">
					<div class="flex-col-c-m size2 bor1">
						<b><span class="l2-txt1 p-b-9 neo-text days"></span></b>
						<span class="s2-txt1 neo-text"><b>Jour(s)</b></span>
					</div>
					<div class="flex-col-c-m size2 bor1">
						<b><span class="l2-txt1 p-b-9 neo-text hours"></span></b>
						<span class="s2-txt1 neo-text"><b>Heure(s)</b></span>
					</div>
					<div class="flex-col-c-m size2 bor1">
						<b><span class="l2-txt1 p-b-9 neo-text minutes"></span></b>
						<span class="s2-txt1 neo-text"><b>Minute(s)</b></span>
					</div>
					<div class="flex-col-c-m size2 bor1">
					<b>	<span class="l2-txt1 p-b-9 neo-text seconds"></span></b>
						<span class="s2-txt1 neo-text"><b>Seconde(s)</b></span>
					</div>
				</div>
			</div>
		...
		<?php }?>
			...
			<div class="neo-center neo-radius neo-padding-16" style="margin-top:20px;">
				<div class="neo-center-simple">
					<h2 class="neo-text"> 
					<?php if($_Theme_['Pied']['-facebook'] == 'true') { ?><a href="<?php echo $_Theme_['Pied']['facebook']; ?>" target="about_blank" ><i class="fab fa-facebook-square"></i></a> <?php } ?>
					<?php if($_Theme_['Pied']['-youtube'] == 'true') { ?><a href="<?php echo $_Theme_['Pied']['youtube']; ?>" target="about_blank" ><i class="fab fa-youtube"></i></a> <?php } ?>
					<?php if($_Theme_['Pied']['-discord'] == 'true') { ?><a href="<?php echo $_Theme_['Pied']['discord']; ?>" target="about_blank" ><i class="fab fa-discord"></i></a> <?php } ?>
					<?php if($_Theme_['Pied']['-twitter'] == 'true') { ?><a href="<?php echo $_Theme_['Pied']['twitter']; ?>" target="about_blank" ><i class="fab fa-twitter"></i></a> <?php } ?>
					</h2>
					<h5 class="neo-text"> Thème <a href="https://file.neocraft.fr/index.php?file=13">NeoCraft Oméga</a> adapté par Guedesite </h5>
				...
				<div class="neo-center-simple"><?php if($_Joueur_['rang'] != 1 AND $_PGrades_['PermsPanel']['access'] == false)
					{ ?>
						<a href="#" class="hvr-forward" onclick="document.getElementById('Connection-mtn').style.display='block'">Connexion administrateur</a><?php
					}
					else
					{ ?>
						<a class="hvr-forward" href="index.php">Accéder au site</a>
					<?php } ?>
	...
	<div class="neo-modal" id="Connection-mtn" style="z-index:1000;">
